                ...
                <div class="row">
                  <div class="col-md-8 form-horizontal">
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <input type="date" class="form-control bradius" name="date">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 control-label" style="text-align: left;">Nomor</label>
                      <div class="col-md-9">
                    ...
                    <div class="form-group">
                      <div class="col-md-3 control-label" style="text-align: left;">
                        <label>Kredit No. Perkiraan</label>
                      </div>
                      <div class="col-md-3">
                        <input type="text" class="form-control bradius" name="knp">
                      </div>
                      <div class="col-md-2 control-label" style="text-align: left;">
                        <label>Kode Bank</label>
                      </div>
                      <div class="col-md-4" >
                        <input type="text" class="form-control bradius" name="kodeb">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-3" style="text-align: left;">
                        <label class="customradio col-md-6"><input onclick="radioA()" type="radio" name="cek" value="C" ><span class="cmark"></span>Cek/Giro</label>
                        <input id="c" type="text" class="cek form-control bradius" name="cekv" disabled="disabled">
                      </div>
                      <div class="col-md-3" style="text-align: left;">
                        <label class="customradio col-md-6"><input onclick="radioB()" type="radio" name="cek" value="B"><span class="cmark"></span>Bank</label>
                        <input id="b" type="text" class="bank form-control bradius" name="cekv" disabled="disabled">
                      </div>
                      <div class="col-md-6 control-label" style="text-align: left;">
                        <label>No. Faktur Pajak</label>
                        <input type="text" class="form-control bradius" name="nfpajak">
                      </div>
                    </div>
